      ...
      .catch((err) => {
        ...
        if (err.response) {
          ...
          if (err.response.status === 400) {
            ...
            toast.error(
              err.response.data.message.map((msg: string) => {
                toast.error(msg);
              })
            );
          ...
          // Handle cases where there's no response (e.g., network issues)
          ...
          <div className="max-w-md text-center">
            ...
            >
              ...
              <g>
                ...
                />
                <polygon
                  points="294.97583 477.41565 284.72217 503.351`38 271.4527 494.30402 279.29373 467.16196 294.97583 477.41565"
                  fill="#ffb6b6"
                />
                <polygon
